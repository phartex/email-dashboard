    ...
    <aside className="fixed top-0 hidden h-screen w-[300px] flex-col border-r border-black bg-[#f5f5f5] md:flex">
      ...
      <div className="flex flex-1 flex-col">
        <button
          ...
          className="mx-auto mb-12 mt-auto flex h-[2.5rem] w-[223px] py-5 justify-center items-center gap-3 rounded-md border border-green-700 px-3 text-sm font-semibold text-red-500 hover:bg-red-50 hover:font-bold transition"
        >
